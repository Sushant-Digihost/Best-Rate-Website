...

                        {
                            insure.map((index)=>(
                                <div className="col-lg-4">
                                    ...
                                    <div className='sd'>
                                                <span className={ index.type ==="" ? "d-none": "catagiry"}>
                                                    {index.type}
                                                </span>
                                            ...
                                            <p>{index.discrip}</p>
                                            <div className="offer">
                                                <span className={index.offer === ""? "d-none":"offerpar"}>
                                                {index.offer}
                                                </span>
                                                <p className={index.extraoff !== true ? "d-none":"offdis"}>If purchase get for <span>2 years</span></p>
                                            </div>
                                    </div>
                                        <div className="prizecontainer">
                                            <h4 className="prize">
                                            <span className="yr">₹</span>{index.price}/<span className="yr">yr</span>
                                            </h4>
                                            <div className="btn_wrap pb-0 text-center">
                                                <a href="#!" className="button2 ">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42" fill="none">
                                                        <path d="M21 10.5C20.5359 10.5 20.0908 10.6844 19.7626 11.0126C19.4344 11.3408 19.25 11.7859 19.25 12.25V19.25H12.25C11.7859 19.25 11.3408 19.4344 11.0126 19.7626C10.6844 20.0908 10.5 20.5359 10.5 21C10.5 21.4641 10.6844 21.9092 11.0126 22.2374C11.3408 22.5656 11.7859 22.75 12.25 22.75H19.25V29.75C19.25 30.2141 19.4344 30.6593 19.7626 30.9874C20.0908 31.3156 20.5359 31.5 21 31.5C21.4641 31.5 21.9092 31.3156 22.2374 30.9874C22.5656 30.6593 22.75 30.2141 22.75 29.75V22.75H29.75C30.2141 22.75 30.6593 22.5656 30.9874 22.2374C31.3156 21.9092 31.5 21.4641 31.5 21C31.5 20.5359 31.3156 20.0908 30.9874 19.7626C30.6593 19.4344 30.2141 19.25 29.75 19.25H22.75V12.25C22.75 11.7859 22.5656 11.3408 22.2374 11.0126C21.9092 10.6844 21.4641 10.5 21 10.5Z" fill="#8AFAF3"/>
                                                    </svg>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <Accordion>
                                <Accordion.Item eventKey="0">
                                    ...
                                    <Accordion.Body>
                                        ...
                                        <div className="prime">
                                            <h4>Website Insurance <span>Get 5% off</span></h4>
                                            <h4>₹499.00</h4>
                                        </div>
                                        <div className="final">
                                            <h4>Subtotal</h4>
                                    ...
                                    <Accordion.Body>
                                       ...
                                       <div className={promo === "" ? "d-none":"codeworning"}>
                                            ...
                                            {isApplied && !isvalisdpromo &&(
                                                 ...
                                                 </svg></span><p><span>INVALID PROMO CODE</span>.</p>
                                             </div>
                                            )}
                                       ...
                                       <div className="porcode">
                                            ...
                                            <a href="#!" onClick={handelcode}>Browse code</a>
                                       </div>
                                    </Accordion.Body>
                                </Accordion.Item>
                            </Accordion>
                ...
                <div className="list1">
                    <Accordion defaultActiveKey={[0]} alwaysOpen>
                        ...
                        <Accordion.Item eventKey="1">
                            <Accordion.Header>Static</Accordion.Header>
                            <Accordion.Body>
                                <div className="listbody">
                                    <ul>
                                        <li><h4>Website Designing</h4> 
