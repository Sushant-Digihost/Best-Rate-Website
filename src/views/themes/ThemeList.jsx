...
export const ThemeList = () => {
  ...
  const filteredThemes = themes.filter((theme) => {
    ...
    return (
      theme.name.toLowerCase().includes(lowerCaseSearchQuery) ||
      theme.catagory.some((cat) =>
        cat.toLowerCase().includes(lowerCaseSearchQuery)
      )
    );
  });
            ...
            <div className="dropdown" ref={dropdownRef}>
              <button className="dropdown-btn" onClick={toggleDropdown}>
                ...
                <span>
                  ...
                  >
                    <path
                      d="M19.4114 8.86328H12.6622H6.58469C5.54469 8.86328 5.02469 10.1199 5.76135 10.8566L11.3731 16.4683C12.2722 17.3675 13.7347 17.3675 14.6339 16.4683L16.7681 14.3341L20.2456 10.8566C20.9714 10.1199 20.4514 8.86328 19.4114 8.86328Z"
                      fill="#122C65"
                    />
                  </svg>
                </span>
                      ...
                      <ul>
                        <li>
                          <a
                            href="#!"
                            className={
                              selectedOption === "Themes" ? "active" : ""
                            }
                            onClick={() => handleOptionClick("Themes")}
                          >
                            <img src={education} /> Themes
                          </a>
                        </li>
                        <li>
                          <a
                            href="#!"
                            className={
                              selectedOption === "Business" ? "active" : ""
                            }
                            onClick={() => handleOptionClick("Business")}
                          >
                            <img src={bag} /> Business
                          </a>
                        </li>
                        <li>
                          <a
                        ...
                        <li>
                          <a
                            href="#!"
                            className={
                              selectedOption === "Restaurant" ? "active" : ""
                            }
                        ...
                        <li>
                          <a
                            href="#!"
                            className={
                              selectedOption === "eCommerce" ? "active" : ""
                            }
                            onClick={() => handleOptionClick("eCommerce")}
                          >
                            <img src={bag} />
                            eCommerce
                          </a>
                        ...
                        <li>
                          <a
                            href="#!"
                            className={
                              selectedOption === "Blog" ? "active" : ""
                            }
                            onClick={() => handleOptionClick("Blog")}
                          >
                            <img src={education} /> Blog
                          </a>
                        </li>
                      </ul>
                    </div>
            ...
            <div className="pagename">
              <ul>
                ...
                <li>
                  ...
                  >
                    <path
                      d="M9.82431 6.00141C9.66381 5.99783 9.5062 6.04496 9.3734 6.13632C9.24059 6.22767 9.13918 6.35874 9.08327 6.51117C9.02736 6.6636 9.01972 6.82988 9.06142 6.98691C9.10312 7.14394 9.19209 7.28385 9.31595 7.3873L14.042 11.4886L9.31595 15.5884C9.23027 15.6522 9.15851 15.7332 9.10518 15.8264C9.05184 15.9195 9.01807 16.0229 9.00598 16.1299C8.9939 16.2369 9.00375 16.3453 9.03494 16.4483C9.06612 16.5513 9.11795 16.6466 9.1872 16.7284C9.25644 16.8101 9.3416 16.8764 9.43735 16.9233C9.53309 16.9702 9.63736 16.9965 9.74361 17.0006C9.84987 17.0048 9.95582 16.9867 10.0548 16.9475C10.1539 16.9082 10.2438 16.8487 10.3191 16.7726L15.73 12.083C15.8149 12.0095 15.8832 11.9183 15.93 11.8156C15.9767 11.7128 16.001 11.601 16.001 11.4878C16.001 11.3747 15.9767 11.2629 15.93 11.1601C15.8832 11.0573 15.8149 10.9661 15.73 10.8926L10.3191 6.19849C10.1824 6.07551 10.0071 6.00577 9.82431 6.00141Z"
                      fill="#DCDCDC"
                    />
                  </svg>
                </li>
                      ...
                      <div className="dropdown" ref={dropdownRef1}>
                        ...
                        >
                          <span className="btntext">
                            Sort by{" "}
                            <span className="catagory">{selectedOption1}</span>
                          </span>{" "}
                          <span>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                                ...
                                <ul>
                                  <li>
                                    <a
                                      href="#!"
                                      className={
                                        selectedOption1 === "Popular"
                                          ? "active"
                                          : ""
                                      }
                                      onClick={() =>
                                        handleOptionClick1("Popular")
                                      }
                                    >
                                      {" "}
                                      Popular <img src={right} alt="" />
                                    </a>
                                  </li>
                                  <li>
                                    <a
                                      href="#!"
                                      className={
                                        selectedOption1 === "Newest"
                                          ? "active"
                                          : ""
                                      }
                                      onClick={() =>
                                        handleOptionClick1("Newest")
                                      }
                                    >
                                      Newest <img src={right} />
                                    </a>
                                  </li>
                                  <li>
                                    <a
                                      href="#!"
                                      className={
                                        selectedOption1 === "Editors Choice"
                                          ? "active"
                                          : ""
                                      }
                                      onClick={() =>
                                        handleOptionClick1("Editors Choice")
                                      }
                                    >
                                      Editors Choice
                                      <img src={right} />
              ...
              <div className="theme-container">
                <div className="row gx-4">
                  {filteredThemes.map((item) => (
                    <div
                      className={
                        item.catagory.includes(selectedOption) ||
