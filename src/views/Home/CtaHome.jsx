...
const CtaHome = () => {
    ...
    useEffect(() => {
        ...
        tl.fromTo(
            ...
            { x: 18, opacity: 1, width: "auto", y: 0, duration: 0.5, ease: 'expoScale(0.5,7,none)' }, "SS"
        )
            .fromTo(
                '.img_2',
                { y: -29, x: 68, opacity: 0, width: '100px' },
                { y: 0, x: -14, opacity: 1, width: "auto", duration: 0.5, ease: 'expoScale(0.5,7,none)' }, "SS"
            )
            .fromTo(
                '.img_3',
                { y: 29, x: -100, opacity: 0, width: '100px' },
                { y: -29, x: 18, opacity: 1, width: "auto", duration: 0.5, ease: 'expoScale(0.5,7,none)' }, "SS"
            )
            .fromTo(
                '.img_4',
