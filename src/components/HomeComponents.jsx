            ...
            >
              ...
              <SwiperSlide>
                <div className="thumb">
                  <span className="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                      <path d="M31.8987 33.7513C31.582 33.7513 31.2654 33.6346 31.0154 33.4013C30.5154 32.918 30.5154 32.1346 30.9987 31.6346C33.8487 28.7346 35.4154 24.9013 35.4154 20.8346C35.4154 12.3346 28.4987 5.41797 19.9987 5.41797C11.4987 5.41797 4.58203 12.3346 4.58203 20.8346C4.58203 24.8846 6.13203 28.7013 8.96536 31.6013C9.4487 32.1013 9.43203 32.8846 8.9487 33.368C8.4487 33.8513 7.66536 33.8346 7.18203 33.3513C3.8987 29.9846 2.08203 25.5346 2.08203 20.8346C2.08203 10.9513 10.1154 2.91797 19.9987 2.91797C29.882 2.91797 37.9154 10.9513 37.9154 20.8346C37.9154 25.5513 36.0987 30.018 32.782 33.3846C32.5487 33.6346 32.2154 33.7513 31.8987 33.7513Z" fill="#020B1F" />
                      <path d="M19.9995 37.0859C16.2161 37.0859 13.1328 34.0026 13.1328 30.2193C13.1328 26.4359 16.2161 23.3359 19.9995 23.3359C23.7828 23.3359 26.8662 26.4193 26.8662 30.2026C26.8662 33.9859 23.7828 37.0859 19.9995 37.0859ZM19.9995 25.8359C17.5828 25.8359 15.6328 27.8026 15.6328 30.2026C15.6328 32.6026 17.5995 34.5693 19.9995 34.5693C22.3995 34.5693 24.3662 32.6026 24.3662 30.2026C24.3662 27.8026 22.4162 25.8359 19.9995 25.8359Z" fill="#020B1F" />
                      <path d="M26.6641 21.25H25.4141C24.0307 21.25 22.9141 20.1333 22.9141 18.75V17.5C22.9141 15.4333 24.5974 13.75 26.6641 13.75C28.7307 13.75 30.4141 15.4333 30.4141 17.5C30.4141 19.5667 28.7307 21.25 26.6641 21.25ZM26.6641 16.25C25.9807 16.25 25.4141 16.8167 25.4141 17.5V18.75H26.6641C27.3474 18.75 27.9141 18.1833 27.9141 17.5C27.9141 16.8167 27.3474 16.25 26.6641 16.25Z" fill="#020B1F" />
                    </svg>
                  </span>
                  <div className="text">
              ...
              <SwiperSlide>
                <div className="thumb">
                  <span className="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M1.66797 4.59785C1.66797 3.89876 2.2458 3.33203 2.95859 3.33203H4.22242C6.609 3.33203 8.6221 5.07503 8.91812 7.3977L9.26037 10.0831H33.656C35.497 10.0831 36.9071 11.6891 36.634 13.4748L34.789 25.5395C34.4415 27.8115 32.4515 29.4924 30.109 29.4924H13.6662C11.3237 29.4924 9.33374 27.8115 8.98627 25.5395L6.8447 11.5367L6.84039 11.5059L6.35682 7.7117C6.22227 6.65595 5.30722 5.86368 4.22242 5.86368H2.95859C2.2458 5.86368 1.66797 5.29695 1.66797 4.59785ZM9.61969 12.6147L11.5389 25.164C11.6969 26.1967 12.6014 26.9607 13.6662 26.9607H30.109C31.1738 26.9607 32.0783 26.1967 32.2363 25.164L34.0813 13.0993C34.1203 12.8441 33.919 12.6147 33.656 12.6147H9.61969Z" fill="#020B1F" />
                      <path d="M32.2112 34.9767C32.2112 35.9089 31.4407 36.6646 30.4904 36.6646C29.54 36.6646 28.7695 35.9089 28.7695 34.9767C28.7695 34.0447 29.54 33.2891 30.4904 33.2891C31.4407 33.2891 32.2112 34.0447 32.2112 34.9767Z" fill="#020B1F" />
                      <path d="M15.0041 34.9767C15.0041 35.9089 14.2337 36.6646 13.2833 36.6646C12.3329 36.6646 11.5625 35.9089 11.5625 34.9767C11.5625 34.0447 12.3329 33.2891 13.2833 33.2891C14.2337 33.2891 15.0041 34.0447 15.0041 34.9767Z" fill="#020B1F" />
                    </svg>
                  </span>
                  <div className="text">
    ...
    <div className="section blog_section_home">
      <Container>
        <div className="section_heading">
          <h2 className="heading">A Holistic Ecosystem Build for Business to Start, Nourish & Prosper</h2>
        </div>
        <div className="blog_grouped">
              ...
              <div className="blog_item">
                ...
                <div className="item_content">
                  ...
                  <h3 className="item_title">
                    <a href="#!">Personalization in Digital Marketing: Strategies and Tools...</a>
                  </h3>
                </div>
            ...
            <div className="col md-6 col-lg-4">
              <div className="blog_item">
                ...
                <div className="item_content">
                  ...
                  <h3 className="item_title">
                    <a href="#!">The Power of Social Proof: How to Use Customer Testimonials...</a>
                  </h3>
                </div>
          ...
          <div className="btn_wrap pb-0 text-center">
            <a href="#!" className="bd-btn-link btn_primary">View All Blogs</a>
          </div>
        </div>
      </Container>
    </div>
        ...
        <div className="pricing_items_group">
          <div className="pricing_item">
            <div className="ps-2">
              ...
              <p className="item_desc">Best for organizations or personalities looking for a dynamic presence and constantly.</p>
              <div className="price_value">
                <h1><span>₹</span>2,099/-</h1>
              </div>
            </div>
                ...
                <span className="list_item_icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                    <g clip-path="url(#clip0_674_2101)">
                      <path d="M9 0C4.0372 0 0 4.0372 0 9C0 13.9628 4.0372 18 9 18C13.9628 18 18 13.9628 18 9C18 4.0372 13.9628 0 9 0Z" fill="#0027B0"/>
