            ...
            <div className="row">
              ...
              <div className="col-lg-2 col-md-3">
                <div className="footer-box">
                  ...
                  <ul>
                    <li>
                      <a href="#!">Discover the community</a>
                    </li>
                    <li>
                      <a href="#!">partner with BestRate</a>
                    </li>
                    <li>
                      <a href="#!">Certified partners</a>
                    </li>
                    <li>
                      <a href="#!">Become a Template Designer</a>
                    </li>
                    <li>
                      <a href="#!">become an affiliate</a>
                    </li>
                    <li>
                      <a href="#!">Become a Global Leader</a>
                    </li>
                    <li>
                      <a href="#!">Find a Meetup Near You</a>
                    </li>
                    <li>
                      <a href="#!">Cookie preferences</a>
                    </li>
              ...
              <div className="row">
                ...
                <div className="col-lg-2 col-md-3">
                  <ul>
                    ...
                    <li>
                      <a href="#!">Cafés & Coffee Shops</a>
                    </li>
                    <li>
                      <a href="#!">Ethnic Cuisine</a>
                    </li>
                    <li>
                ...
                <div className="col-lg-2 col-md-3">
                  <ul>
                    ...
                    <li>
                      <a href="#!">Emergency Dentistry</a>
                    </li>
                    <li>
                      <a href="#!">Holistic Dentistry</a>
                    </li>
                  </ul>
                </div>
                <div className="col-lg-2 col-md-3">
                ...
                <div className="col-lg-2 col-md-3">
                  <ul>
                    ...
                    <li>
                      <a href="#!">Industrial Real Estate</a>
                    </li>
                    <li>
                      <a href="#!">Land and Lots</a>
                    </li>
                    <li>
                      <a href="#!">Luxury Real Estate</a>
                    </li>
                    <li>
                      <a href="#!">Mixed-Use Developments</a>
                    </li>
                    <li>
                      <a href="#!">Vacation/Short-Term Rentals</a>
                    </li>
                    <li>
                      <a href="#!">Multi-Family Real Estate</a>
                    </li>
                    <li>
                      <a href="#!">Retail Real Estate</a>
                    </li>
                  </ul>
                </div>
                <div className="col-lg-2 col-md-3">
                  <ul>
                    <li>
                      <a href="#!">Freight and Cargo Transport</a>
                    </li>
                    <li>
                      <a href="#!">Passenger Transport</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="#!">Rail Transport</a>
                    </li>
                    <li>
                      <a href="#!">Trucking and Road Transport</a>
                    </li>
                    <li>
                      <a href="#!">Courier and Parcel Services</a>
                    </li>
                    <li>
                      <a href="#!">Public Transport</a>
                    </li>
                    <li>
                      <a href="#!">Specialized Transport</a>
                    </li>
                  </ul>
                </div>
              </div>
